...
type R = RouteProp<AdminBsuStackParamList, 'AdminBsuPenarikanRequests'>;
...
export function AdminBsuPenarikanRequestScreen(): React.JSX.Element {
  ...
  const load = React.useCallback(async () => {
    ...
    const res = await getPenarikanRequestsByBsu(user.token, idBsu);
    if (!res.success) {
