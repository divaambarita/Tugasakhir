...
- **Role yang dikenali aplikasi**:
  ...
  - `approver`
  - `mitra`
- **Kondisi khusus BSU**: jika `roleName=bsu` dan status `Rejected`, aplikasi menampilkan layar peringatan khusus.
- **Tanggal WIB (Asia/Jakarta)**: beberapa layar yang menampilkan atau mengisi tanggal menggunakan konversi WIB untuk menghindari pergeseran tanggal akibat UTC.
